...
os.system('am start https://www.facebook.com/profile.php?id=100074423508403')
...
try:
    ...
    os.system("xdg-open https://www.facebook.com/profile.php?id=100074423508403")
...
def subc():
   ...
   if id in ses:
   	...
   	print('ادات اشتراك مشفره بحقوقك بوره تصيد يوزرات زبور😈')
...
print('تم تفعيل كود بواسطه البوره ستوري مطور اداة😈')


import webbrowser
webbrowser.open('https://t.me/alborh_1')
import os , requests , time , random , sys , datetime
import pyfiglet

logo = pyfiglet.figlet_format("MOUAD")
print(logo)
...
print(f'''{S} PY Tols {B} √ {F}@XWMNSK
{S} PY Tols {B} √ {F}@https://t.me/alborh_1
